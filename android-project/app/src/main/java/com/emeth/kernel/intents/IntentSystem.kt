...
enum class Intent {
    ...
    OPEN_SETTINGS_NETWORK,
    OPEN_SETTINGS_NFC,
    OPEN_SETTINGS_CAST,
    OPEN_SETTINGS_HOTSPOT,
    OPEN_SETTINGS_AIRPLANE_MODE,
    OPEN_SETTINGS_VPN,
    OPEN_SETTINGS_DATA_ROAMING,
    OPEN_SETTINGS_PRIVACY,
    OPEN_SETTINGS_BIOMETRIC,
    OPEN_SETTINGS_DEVELOPER,
    OPEN_SETTINGS_ABOUT,
    OPEN_SETTINGS_ACCOUNT,
    OPEN_SETTINGS_NOTIFICATIONS,
